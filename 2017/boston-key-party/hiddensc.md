...
The only way to leak information from the program is to use the information it gives as feedback in print statements. The only information it supplies is whether or not malloc succeeds. This is the attack vector I chose to leak the address of the shellcode.
